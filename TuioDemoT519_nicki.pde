...
String getStudentName(float spinnerAngle){
   ...
   text(degreeInterval, 10, 100);
     if(spinnerAngle >= 0* && spinnerAngle <= 1*){
       stuName="Lilly";
     }
     else if (spinnerAngle >= 0.3 && spinnerAngle <=1.3) {
       stuName="Raegan";
     }
     else if (spinnerAngle >= 1.3 && spinnerAngle <=2.1) {
       stuName="James";
     }
     else if (spinnerAngle >= 2.1 && spinnerAngle <=2.4) {
       stuName="Raven";
     }
    return  stuName;
}
